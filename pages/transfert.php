...
<body style="background-color:#ffe4e6">
    <nav class="flex overflow-auto items-center justify-between flex-wrap bg-rose-200 p-10">
        ...
        <a href="#" class="btn">
            <svg class="h-8 w-8 text-rose-800 icon"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  
                ...
                <?php if($transf->id == $image->id): ?>
                    <div class="text-lg flex-wrap">
                        <div class="flex flex-col justify-center">          
                            <div class="flex justify-center l"><img class="w-1/4 h-1/4 max-md:w-1/2 max-md:h-1/2" src="assets/image/joueur/<?= $image->img ?>" alt="<?= $transf->prenom ?> &nbsp; <?= $transf->nom ?>" ></div><br>
