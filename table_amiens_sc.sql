...
insert into `calendrier` (journee, stade, lieu, `date`, equipe, img, score, localisation) values
    ...
    (21, 'Stade René Gaillard', 'Niort', '31 Janvier 2023', 'Niort', 'Niort-min.png', '1-3','Exterieur'),
...
insert into `classement`(num, equipe, img, journee, point, gagne, `null`, perdu, diff) values
    (1, 'Havre AC', 'Le_Havre-min.png', 21,46, 13, 7, 1, 23),
    (3, 'Girondins de Bordeaux', 'Bordeaux-min.png', 21, 36, 10, 6, 5, 13),
    (2, 'FC Sochaux', 'Sochaux-min.png', 21, 36, 11, 3, 7, 15),
    (6, 'Amiens SC', 'Logo_Amiens_SC_3-min.png', 21, 33, 9, 6, 6, 4),
    (7, 'Grenoble Foot 38', 'Grenoble-min.png', 21, 33, 9, 6, 6, 3),
    (5, 'FC Metz', 'Metz-min.png', 21, 33, 9, 6, 6, 9),
    (8, 'SM Cean', 'Caen-min.png', 21, 29, 7, 9, 5, 3),
    (10, 'Quevilly-Rouen', 'QRM-min.png', 21, 28, 7, 7, 7, 0),
    (15, 'Valenciennes FC', 'Valenciennes-min.png', 21, 26, 6, 8, 7, -5),
    (13, 'Paris FC', 'Paris-min.png', 21, 27, 7, 6, 8, -5),
    (4, 'SC Bastia', 'Bastia-min.png', 21, 34, 10, 4, 7, 0),
    (11, 'EA Guinganp', 'Guingamp-min.png', 21, 27, 7, 6, 8, -3),
    (14, 'Pau FC', 'Pau-min.png', 21, 26, 6, 8, 7, -5),
    (9, 'FC Annecy', 'Annecy-min.png', 21, 28, 7, 7, 7, 3),
    (12, 'Laval', 'Laval-min.png', 21, 27, 8, 3, 10, -5),
    (17, 'Dijon FCO', 'Dijon-min.png', 21, 21, 5, 6, 10, -5),
    (18, 'Rodez AF', 'Rodez-min.png', 21, 20, 4, 8, 9, -9),
    (16, 'Nîmes', 'Nimes-min.png', 21, 22, 6, 4, 11, -9),
    (20, 'Niort', 'Niort-min.png', 21, 17, 4, 5, 12, -17),
    (19, 'AS Saint-Etienne', 'Saint_Etienne-min.png', 21, 18, 5, 7, 9, -6);
